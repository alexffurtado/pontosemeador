...
CREATE TABLE IF NOT EXISTS funcionarios (
  ...
  verificar_atraso INTEGER NOT NULL DEFAULT 1,
  verificar_saida_antecipada INTEGER NOT NULL DEFAULT 1,
...
if (!colunaExiste('funcionarios', 'verificar_atraso')) {
  db.exec('ALTER TABLE funcionarios ADD COLUMN verificar_atraso INTEGER NOT NULL DEFAULT 1');
}
if (!colunaExiste('funcionarios', 'verificar_saida_antecipada')) {
  db.exec('ALTER TABLE funcionarios ADD COLUMN verificar_saida_antecipada INTEGER NOT NULL DEFAULT 1');
}

...
function register(router) {
  router.get(
    ...
    withAuth(async ({ res, user }) => {
      ...
      const proximo = proximoTipo(ultimoGeral ? ultimoGeral.tipo : null, user.tem_intervalo);
  ...
  router.post(
    ...
    withAuth(async ({ req, res, user }) => {
      ...
      const tipoAutomatico = proximoTipo(ultimoGeral ? ultimoGeral.tipo : null, user.tem_intervalo);

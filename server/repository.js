  ...
  async criar(dados) {
    ...
    const { rows } = await pool.query(
      `INSERT INTO funcionarios
        (nome, email, login, senha_hash, cargo, is_admin, ativo, jornada_entrada, jornada_saida, carga_horaria_diaria_minutos, tolerancia_minutos, dias_trabalho, verificar_atraso, verificar_saida_antecipada, tem_intervalo)
